import { TeamBoardsAction } from '../../interface/TeamBoardActions';
import {
  ...
  export const invitedCollaboator = (team: any): TeamBoardsAction => {
    return {
  ...
  export const createdNewTeamBoard = (team: any): TeamBoardsAction => {
    return {
  ...
  export const gotAllTeamBoards = (team: any): TeamBoardsAction => {
    return {
  ...
  export const setTeamBoard = (team: any): TeamBoardsAction => {
    return {
      type: SET_TEAM_BOARD,
      team,
    };
  ...
  export const removeTeamBoard = (team: any): TeamBoardsAction => {
    return {
  ...
  export const reArrangeTeamBoard = (team: any): TeamBoardsAction => {
    return {
  ...
  export default function reducer(draft: any, action: TeamBoardsAction): void {
    switch (action.type) {
