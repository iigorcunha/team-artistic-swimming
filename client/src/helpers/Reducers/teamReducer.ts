...
export const createdNewTeam = (teams: any): UserTeamAction => {
  return {
    type: CREATE_TEAM,
    teams,
  };
...
export const gotAllTeams = (teams: any): UserTeamAction => {
  return {
...
export default function reducer(draft: any, action: UserTeamAction): void {
  switch (action.type) {
    case CREATE_TEAM:
